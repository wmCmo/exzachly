...
export default function EmptyChar() {
    ...
    return (
        <div className="flex flex-col items-center justify-center h-screen px-8">
            ...
            <button onClick={() => navigator.clipboard.writeText(empChar)} className="bg-neutral-200 p-4 dark:bg-neutral-900 rounded mt-8 outline-1 hover:outline-offset-1">Copy U+200E</button>
        </div>
    )
}
