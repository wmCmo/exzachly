...
export default function About() {
    ...
    return (
        <div className='flex flex-col items-center gap-8 mx-5 text-neutral-800 dark:text-neutral-200'>
            <h1 className='text-center text-vw leading-none sm:text-7xl font-bold '>My {vcf ? 'Digital Contact' : 'LinkedIn'}</h1>
            ...
            <a href={url} className='bg-neutral-50 hover:bg-white dark:bg-neutral-950 px-6 py-4 rounded-xl hover:-translate-y-1 transition-all duration-200 ease-in-out dark:hover:bg-neutral-900 font-bold'>Download Contact File</a>
